...
from .models import UserPoints, UserAchievement
from .serializers import UserPointsSerializer, UserAchievementSerializer
...
class UserPointsViewSet(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        achievements = UserAchievementSerializer(UserAchievement.objects.filter(user_id=request.user.id),
